      ...
      <div className="techStackSec--head">
        ...
        <motion.div initial="hidden" animate={controls} variants={opacityVariant} transition={{ duration: 1, delay: 1 }} onAnimationComplete={() => handleComplete()} className="techStackSec--head--detail">
          <p className="theme--detail">
            <ScrambleText delay={1}>Explore the technologies that define my craft: HTML5, CSS3, JavaScript, TypeScript, React, Redux, Firebase,Sass, Next.js, Vue.js, Node.js, Python, C#, SQL, MongoDB, and Docker. Each tool is carefully selected to create seamless, modern web experiences.</ScrambleText>
          </p>
        </motion.div>
      </div>
