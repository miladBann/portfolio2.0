  ...
  return (
    <header ref={ref}>
      ...
      <motion.div initial="hidden" animate={controls} variants={blurVariants} transition={{ duration: 1, delay: 0.5 }} className="header--top">
        <h3>
          <a href="https://github.com/miladBann" target={"_blank"} rel="noopener noreferrer">
            <ScrambleText shuffle delay={0.5}>
              GITHUB
            </ScrambleText>
          </a>
          <span className="header--hash">{"//"}</span>
          <a href="https://www.linkedin.com/in/milad-bannourah/" target={"_blank"} rel="noopener noreferrer">
            <ScrambleText shuffle delay={1}>
              LINKEDIN
            </ScrambleText>
          </a>
          <span className="header--hash">{"//"}</span>
          <a href="Milad-Bannourah-Resume-FS.pdf" target={"_blank"} rel="noopener noreferrer">
      ...
      <motion.div initial="hidden" animate={controls} variants={blurVariants} transition={{ duration: 1, delay: 4 }} className="header--bottom">
        <div>
          ...
          <p className="theme--detail">
            <ScrambleText shuffle delay={4}>
              Hello, I’m Milad, I tackle complex engineering challenges daily, alongside a team of elite software engineers. My mission is to continuously advance in Full Stack Web Development, using my growing expertise to drive societal progress through technology.
            </ScrambleText>
          </p>
        </div>
      ...
      <h1 className="header--name">
        <TextWriting controls={controls} text={"Milad Bannourah"} noblink />
        <br />
