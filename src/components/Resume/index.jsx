        ...
        <div className="resume--grid--detail">
          ...
          <div className="resume--grid--detail--data">
            <div className="resume--grid--detail--data--name">
              <h2>
                <ParaWriting stagger={0.08} text={"Milad Bannourah"} />
              </h2>
              <h4>
              ...
              <motion.div initial="hidden" animate={controls} variants={blurVariants} transition={{ duration: 1, delay: 0.5 }} onAnimationComplete={() => handleComplete()} className="resume--grid--detail--data--name--icons">
                <a href="https://github.com/miladBann" target="_blank" rel="noreferrer">
                  <Icon img={<FaGithub />} />
                </a>
                <a href="https://www.linkedin.com/in/milad-bannourah/" target="_blank" rel="noreferrer">
                  <Icon img={<FaLinkedin />} />
                </a>
                <a href="Milad-Bannourah-Resume-FS.pdf">
                  <Icon img={<IoDocumentText />} />
                </a>
              </motion.div>
            </div>
